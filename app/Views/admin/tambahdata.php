...
<form class="box" action="/buku/tambahdata" method="POST">
    <?= csrf_field(); ?>
    <div class="form-group row">
        <label for="kode_buku" class="col-sm-2 col-form-label">Kode Buku</label>
        <div class="col-sm-10">
            <input type="text" class="form-control  <?= ($validation->hasError('kode_buku')) ? 'is-invalid' : ''; ?>" id="kode_buku" name="kode_buku" value="<?= old('kode_buku'); ?>" autofocus>
    ...
    <div class="form-group row">
        <div class="col-sm-10">
            <button type="submit" class="button1">Tambah Data</button>
